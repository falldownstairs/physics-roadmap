  ...
  videos: [
    {
      ...
      questions: [
        ...
        {
          type: 'math-input',
          question: "Given the diagram, a ball rolls $\\text{horizontally}$ off a table of height ($h$) $1.50 \\text{ m}$ and lands $0.65 \\text{ m}$ away from the base of the table. Calculate the $\\text{initial horizontal launch speed}$ ($v_{0x}$) of the ball in $\\text{m/s}$. (Use $g = 9.8 \\text{ m/s}^2$)",
          image: {
            src: 'ball_off_table_diagram.png',
            alt: 'Diagram showing a ball launched horizontally off a table of height h, landing a distance x from the base.'
          },
          mathAnswer: "1.16",
          answerRange: 0.01,
          explanation: "Since the ball is launched horizontally, the initial vertical velocity ($v_{iy}$) is $0 \\text{ m/s}$. The horizontal and vertical motions are independent.\n\n1. Find time from vertical motion:\n\nUse: $$\\Delta y = v_{iy}t + \\frac{1}{2}a_y t^2$$ We have: $$-1.50 \\text{ m} = 0 + \\frac{1}{2}(-9.8 \\text{ m/s}^2) t^2$$\n\nSolving for $t$ gives:\n\n$$t = \\sqrt{\\frac{2(1.50 \\text{ m})}{9.8 \\text{ m/s}^2}} \\approx 0.553 \\text{ s}$$\n\n2. Find initial speed from horizontal motion:\n\nThe horizontal velocity is constant, so $\\Delta x = v_{0x}t$.\n\nSolving for $v_{0x}$:\n\n$$v_{0x} = \\frac{\\Delta x}{t} = \\frac{0.65 \\text{ m}}{0.553 \\text{ s}} \\approx 1.16 \\text{ m/s}$$"
        }
      ]
    }
  ]
