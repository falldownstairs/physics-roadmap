...
export default function HeroSection() {
  return (
    <section aria-label="PhysicsRoadmap overview" className="w-full min-h-screen px-3 sm:px-6 md:px-8 lg:px-12 bg-slate-200 relative z-10 flex items-center justify-center py-16 sm:py-0">
